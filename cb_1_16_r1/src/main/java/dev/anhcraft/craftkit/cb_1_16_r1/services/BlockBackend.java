...
import org.bukkit.craftbukkit.v1_16_R1.block.CapturedBlockState;
...
public class BlockBackend extends CBModule implements CBBlockBackend {
    ...
    private boolean setTypeAndData(BlockPosition blockposition, IBlockData iblockdata, int i, World world, boolean light) {
        ...
        // * this -> world
        else if (!world.isClientSide && world.isDebugWorld()) {
            return false;
        }
        else {
            // * this -> world
            ...
            if (iblockdata1 == null) {
                ...
                if (light) { // ADD
                    ...
                    // * this -> world
                    if (iblockdata2 != iblockdata1 && (iblockdata2.b(world, blockposition) != iblockdata1.b(world, blockposition) || iblockdata2.f() != iblockdata1.f() || iblockdata2.e() || iblockdata1.e())) {
