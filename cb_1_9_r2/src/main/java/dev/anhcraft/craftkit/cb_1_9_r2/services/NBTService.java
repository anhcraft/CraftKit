...
public class NBTService extends CBModule implements CBNBTService {
    ...
    private static NBTTag fromNMS(NBTBase tag){
        switch (tag.getTypeId()) {
            case 1: return new ByteTag(((NBTTagByte) tag).f());
            case 2: return new ShortTag(((NBTTagShort) tag).e());
            case 3: return new IntTag(((NBTTagInt) tag).d());
            case 4: return new LongTag(((NBTTagLong) tag).c());
            case 5: return new FloatTag(((NBTTagFloat) tag).h());
            case 6: return new DoubleTag(((NBTTagDouble) tag).g());
            case 7: return new ByteArrayTag(((NBTTagByteArray) tag).c());
            case 8: return new StringTag(((NBTTagString) tag).a_());
            case 9:
            ...
            case 10:
                ...
                return compound;
            case 11: return new IntArrayTag(((NBTTagIntArray) tag).c());
        }
